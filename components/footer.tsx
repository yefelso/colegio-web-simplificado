    ...
    <footer className="bg-gray-100 border-t border-gray-200">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">Colegio María de los Ángeles</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/informacion" className="text-gray-500 hover:text-gray-700">
                  Información
                </Link>
              </li>
              <li>
                <Link href="/nosotros" className="text-gray-500 hover:text-gray-700">
                  Nosotros
                </Link>
              </li>
              <li>
